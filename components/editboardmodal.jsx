...
export default function EditBoardModal({ visible, onClose, onUpdate, onDelete, board }) {
  ...
  // Initialize form with board data when modal opens
  useEffect(() => {
    if (board && visible) {
      setTitle(board.title || "");
      setDescription(board.description || "");
      setLayout(board.layout || "grid");
      setIsPublic(board.isPublic || false);
      setImage(board.coverImage || null);
    }
  }, [board, visible]);
      ...
      <View style={styles.modalContainer}>
        <View style={[styles.modalContent, { backgroundColor: colors.background }]}>
          <View style={[styles.header, { borderBottomColor: colors.border }]}>
            <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Edit Board</Text>
          ...
          <ScrollView style={styles.form}>
            <Text style={[styles.label, { color: colors.textPrimary }]}>Board Image</Text>
            <View style={styles.addImage}>
              <TouchableOpacity onPress={pickImage}>
                {image ? (
                  ...
                  <Text style={{ color: colors.textSecondary }}>+ Add Image</Text>
                )}
              </TouchableOpacity>
            </View>
